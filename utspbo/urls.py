...
urlpatterns = [
    ...
    path('tambahpeta/', tambahpeta),
    path("halamanjurnal/updatejurnal/<int:id_home>", updatejurnal, name = 'updatejurnal'),
    path("halamanjurnal/deletejurnal/<int:id_home>", deletejurnal, name = 'deletejurnal'),
    path('koorapi/', koorApi, name='koorsApi'),
]
